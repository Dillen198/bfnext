            ...
            Action {
                ...
                kind: ActionKind::Awacs(AwacsCfg {
                    ...
                    plane: AiPlaneCfg {
                        ...
                        speed: 200.,
                        freq: Some(125000000),
                        tacan_channel: Some(1),
                        tacan_band: Some(TacanBand::Y),
                        tacan_callsign: Some("MAGIC".into()),
                        callsign_id: None,
        ...
        (
            ...
            Action {
                ...
                kind: ActionKind::Tanker(AiPlaneCfg {
                    ...
                    speed: 180.,
                    freq: Some(125000000),
                    tacan_channel: Some(11),
                    tacan_band: Some(TacanBand::Y),
                    tacan_callsign: Some("TEX".into()),
                    callsign_id: None,
                    callsign_number: None,
                }),
            },
        ...
        (
            ...
            Action {
                ...
                kind: ActionKind::Tanker(AiPlaneCfg {
                    ...
                    speed: 180.,
                    freq: Some(264000000),
                    tacan_channel: Some(12),
                    tacan_band: Some(TacanBand::Y),
                    tacan_callsign: Some("ARCO".into()),
                    callsign_id: None,
                    callsign_number: None,
                }),
            },
